...
void testAmbassadorCardEffect(int choice1, int choice2, struct gameState *post, int handPos) {
	...
	ambassadorCardEffect(choice1, choice2, post, handPos);
...
int main() {
	...
	choice2 = 18;
	handpos = 4;
	testAmbassadorCardEffect(choice1, choice2, &G, handpos);
