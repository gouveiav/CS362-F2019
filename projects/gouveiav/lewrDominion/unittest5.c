...
void testMineCardEffect(int choice1, int choice2, struct gameState *post, int handPos, int currentPlayer) {
	...
	mineEffect(choice1, choice2, post, handPos, currentPlayer);
...
int main() {
	...
	choice2 = gold;
	testMineCardEffect(choice1, choice2, &G, handPos, currentPlayer);
